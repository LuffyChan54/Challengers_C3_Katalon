...
if (transaction_type.equals('deposit')) {
    ...
    WebUI.click(findTestObject('Object Repository/Create_recurring_transaction/Page_Create new recurring transaction/input_create_another'))
} else if (transaction_type.equals('withdrawal')) {
...
WebUI.verifyTextPresent('Success! Recurring transaction.*', true)

WebUI.navigateToUrl('https://firefly.buudadawg.online/recurring/create')
...
WebUI.click(findTestObject('Create_recurring_transaction/Page_Recurring transactions  Firefly III/delete_trash_button'))

WebUI.click(findTestObject('Create_recurring_transaction/Page_Delete recurring transaction/delete_submit'))
